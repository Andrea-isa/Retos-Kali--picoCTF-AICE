...
┌──(kali㉿kali)-[~/…/CarpetaCompartida.Windows/RetosKali-exam--editar/CarpetaKali-exam1/Retos-Forensic picoCTF 2021]
└─$ ls
'01- Matryoshka doll.md'  '03- MacroHard WeakEdge.md'  '0n- Nombre 1 3.md'     docProps    _dolls.jpg.extracted     ppt     tunn3l_v1s10n
'02- tunn3l_v1s10n.md'    '0n- Nombre 1 2.md'          '[Content_Types].xml'   dolls.jpg  'Forensics is fun.pptm'   _rels
                                                                                                                                                                      
┌──(kali㉿kali)-[~/…/CarpetaCompartida.Windows/RetosKali-exam--editar/CarpetaKali-exam1/Retos-Forensic picoCTF 2021]
└─$ cd ppt   
                                                                                                                                                                      
┌──(kali㉿kali)-[~/…/RetosKali-exam--editar/CarpetaKali-exam1/Retos-Forensic picoCTF 2021/ppt]
└─$ ls
...
┌──(kali㉿kali)-[~/…/CarpetaKali-exam1/Retos-Forensic picoCTF 2021/ppt/slideMasters]
└─$ ls
