...
└─$ ls
'01- Sleuthkit Intro.md'  '02- Operation Oni.md'  '03- Enhance!.md'   disk2.img   disk.img   drawing.flag.svg   key_file
...
└─$ {3nh4nc3d_d0a757bf}
```
Entre las 8 ultimas lìneas de còdigo, encontramos dos partes:
1. { 3 n h 4 n
2. c 3 d _ d 0 a 7 5 7 b f }
Si juntamos ambas parte y eliminamos los espacios, ademàs añadimos picoCTF, obtenemos la flag de este reto.
